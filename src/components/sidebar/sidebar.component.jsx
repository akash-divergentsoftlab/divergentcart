        ...
        <div className='sidebar'>
            ...
            <div id="sidebar" class="span3">
                ...
                <ul id="sideManu" class="nav nav-tabs nav-stacked">
                    <li class="subMenu open"><a href='/#'> ELECTRONICS [230]</a>
                        <ul>
                    ...
                    <li class="subMenu"><a href='/#'> CLOTHES [840] </a>
                    ...
                    <li class="subMenu"><a href='/#'>FOOD AND BEVERAGES [1000]</a>
                        <ul style={{ display: 'none' }}>
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <h4 style={{ textAlign: 'center' }}><a class="btn" href="product_details.html"> <i
                            class="icon-zoom-in"></i></a> <a a href='/#' class="btn" >Add to <i
